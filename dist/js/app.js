...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var popoverList = popoverTriggerList.map(function (element) {
    return new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Popover(element, {
...
document.addEventListener("click", function (e) {
  if (e.target && e.target.classList.contains("close")) {
    var popover = bootstrap__WEBPACK_IMPORTED_MODULE_0__.Popover.getInstance(e.target.closest(".popover"));
    popover.hide();
  }
});
document.addEventListener("DOMContentLoaded", function () {
  var myPopover = document.getElementById('myPopover');
  var myPopover2 = document.getElementById('myPopover2'); // Show alert when the popover has finished being hidden 
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click", function () {
    var myModal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(document.getElementById("modalCenter"));
    myModal.show();
  });
});
/********************************
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkphpvalet"] = self["webpackChunkphpvalet"] || [];
